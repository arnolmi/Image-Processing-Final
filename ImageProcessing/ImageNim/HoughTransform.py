...
class HoughTransform(object):
    ...
    def is_square(self, p1, p2, p3, p4):
        if any((a == b for (a, b,) in itertools.combinations((p1,
         p2,
         p3,
         p4), 2))):
            return False
        ...
        return all((self.distsq(far_pt, p) == pmin for p in (p2, p3, p4) if p != far_pt))
